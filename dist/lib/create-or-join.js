    ...
    if (optionsRef.current.share) {
        ...
        if (globals_1.sharedWebSockets[url] === undefined) {
            globals_1.sharedWebSockets[url] = optionsRef.current.eventSourceOptions
                ...
                : constants_1.isReactNative
                    // @ts-ignore third argument is only available in React Native
                    ? new WebSocket(url, optionsRef.current.protocols, { headers: (_a = optionsRef.current.headers) !== null && _a !== void 0 ? _a : {} })
        ...
        webSocketRef.current = optionsRef.current.eventSourceOptions
            ...
            : constants_1.isReactNative
                // @ts-ignore third argument is only available in React Native
                ? new WebSocket(url, optionsRef.current.protocols, { headers: (_b = optionsRef.current.headers) !== null && _b !== void 0 ? _b : {} })
                : new WebSocket(url, optionsRef.current.protocols);
        setReadyState(constants_1.ReadyState.CONNECTING);
